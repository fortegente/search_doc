 ...
 */
    ...
    /** @name database information */
        ...
        $this->dbPwd = 'ufufhby88'; // database user password
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://oxid.local'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = '/home/likewise-open/ISM-ECOMPANY/d.martyniuk/projects/oxid.local';
        $this->sCompileDir = '/home/likewise-open/ISM-ECOMPANY/d.martyniuk/projects/oxid.local/tmp';
