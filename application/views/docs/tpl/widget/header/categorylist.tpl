...
<ul id="navigation" class="sf-menu">
    ...
    [{/oxifcontent}]
    <li [{if $homeSelected == 'true' }]class="current"[{/if}]><a [{if $homeSelected == 'true'}]class="current"[{/if}] href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=news"}]">[{oxmultilang ident="DOCS_NEWS"}]</a></li>
    ...
    <li [{if $homeSelected == 'true' }]class="current"[{/if}]><a [{if $homeSelected == 'true'}]class="current"[{/if}] href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=register" }]">[{oxmultilang ident="DOCS_REGISTER"}]</a></li>
