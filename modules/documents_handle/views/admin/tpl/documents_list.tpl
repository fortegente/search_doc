...
<div id="liste">
    <form name="search" id="search" action="[{$oViewConf->getSelfLink() }]" method="post">
        [{include file="_formparams.tpl" cl="documents_list" lstrt=$lstrt actedit=$actedit oxid=$oxid fnc="" language=$actlang editlanguage=$actlang}]
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <colgroup>
                ...
                <tr class="listitem">
                    ...
                    <td valign="top" class="listfilter">
                        <div class="r1"><div class="b1">
                                <input class="listedit" type="text" size="20" maxlength="128" name="where[zsdocuments][name]" value="[{ $where.zsdocuments.name }]">
                            </div></div>
                    </td>
                    <td valign="top" class="listfilter" colspan="2">
                        <div class="r1"><div class="b1">
                                ...
                                <input class="listedit" type="text" size="10" maxlength="128" name="where[zsdocuments][state]" value="[{ $where.zsdocuments.state }]">
                        </div>
                        </div>
                    </td>
                </tr>
        ...
        <tr id="row.[{$_cnt}]">
            ...
            <td class="[{ $listclass}]">
                [{if !$listitem->isOx() && !$readonly  && !$listitem->blPreventDelete}]
                    <a href="Javascript:top.oxid.admin.deleteThis('[{ $listitem->zsdocuments__oxid->value }]');" class="delete" id="del.[{$_cnt}]" [{include file="help.tpl" helpid=item_delete}]></a>
                [{ /if }]
            </td>
            [{/block}]
        </tr>
